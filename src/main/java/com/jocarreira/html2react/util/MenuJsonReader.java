...
import com.jocarreira.html2react.model.ItemMenu;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (ItemMenu item : menu) {
                //String subDir = StringUtils.stripAccents(
                //        item.getLabel().replaceAll(">", "") + item.getLink().replaceAll(".php", ""));
                //subDir = CaseUtils.toCamelCase(subDir, false, ' '); // Transforma em CamelCase
