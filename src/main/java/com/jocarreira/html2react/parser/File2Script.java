package com.jocarreira.html2react.parser;

import com.jocarreira.html2react.util.FileUtil;
import com.jocarreira.html2react.util.HtmlToJson;
import com.jocarreira.html2react.util.HtmlToReactConverter;
...
//                "</lu>";
        ...
        try {
            ...
            convert = HtmlToJson.convertHtmlToJson(html);
        } catch (Exception e) {
